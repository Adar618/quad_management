...
class OperatorRBACTests {
    ...
    private String loginOp() throws Exception {
        String body = om.writeValueAsString(Map.of("username", "op1", "password", "secret"));
    ...
    void operator_perms_enforced() throws Exception {
        ...
        String patchStatusBody = om.writeValueAsString(Map.of("status", "MAINTENANCE"));
